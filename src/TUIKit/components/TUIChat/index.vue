<template>
	<div class="chat">
		<div :class="['tui-chat', !isPC && 'tui-chat-h5']">
			...
			<!-- 群组管理 -->
			<div v-if="isUniFrameWork && isGroup && groupManageExt" class="group-profile" @click="handleGroup">
				{{ groupManageExt.text }}
				<!-- 更多 -->
			</div>
		</div>
...
function onCurrentConversationUpdate(conversation: IConversationModel) {
	...
	TUICore.notifyEvent(TUIConstants.TUIChat.EVENT.CHAT_STATE_CHANGED, TUIConstants.TUIChat.EVENT_SUB_KEY.CHAT_OPENED, {
